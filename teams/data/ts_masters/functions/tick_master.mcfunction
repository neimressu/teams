...
execute as @p if data entity @s {SelectedItem:{id:"minecraft:warped_fungus_on_a_stick", tag: {Damage:0, Tags:1}}} if score @s rod_click >= check rod_click run scoreboard players set @s bluejoin 1

execute as @p if data entity @s {SelectedItem:{id:"minecraft:warped_fungus_on_a_stick", tag: {Damage:0, Tags:2}}} if score @s rod_click >= check rod_click run scoreboard players set @s greenjoin 1
